...
from readers.vqa_base_data_fetcher import AttentionDataReader as Reader
...
tf.flags.DEFINE_string("version", "v1",
                       ...
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "/scratch/fl302/inverse_vqa/model/%s_kpvqa2_%s",
...
def train():
    ...
    reader = Reader(batch_size=100,
                    subset='kptrain', model_name=model_name,
                    epsilon=0.5, feat_type='res5c',
                    counter_sampling=do_counter_sampling)

    # Run training.
    train_framework_curriculum.train(
        train_op,
        train_dir,
