...
class VocabularyConfig(object):
    def __init__(self):
        ...
        # config 1
        self.ivqa_agent_voca_bsize = self.vocab_size + 1
        self.pad_token = self.vocab_size
        self.vqa_vocab_size = self.vocab_size
        # config 2
        # self.ivqa_agent_voca_bsize = self.vocab_size
        # self.pad_token = self.vocab_size - 1
        self.answer_vocab_size = 13786


VOCAB_CONFIG = VocabularyConfig()


class AnswerVocabularyConfig(object):
    def __init__(self):
        self.start_token_id = 0
        self.end_token_id = 1
        self.vocab_size = 13786
        # config 1
        self.ivqa_agent_voca_bsize = self.vocab_size + 1
        self.pad_token = self.vocab_size
        self.vqa_vocab_size = self.vocab_size
...
ANS_VOCAB_CONFIG = AnswerVocabularyConfig()
