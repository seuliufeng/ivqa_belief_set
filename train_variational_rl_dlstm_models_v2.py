...
import var_rl_training_util_v2 as training_util
from readers.ivqa_reader_creater import create_reader
from var_ivqa_rewards_v2 import MixReward
...
tf.flags.DEFINE_string("version", "v1",
                       ...
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "model/%s_dlstmv2_restval_%s",
...
def train():
    ...
    env.set_cider_state(True)
    env.set_language_thresh(0.333)
