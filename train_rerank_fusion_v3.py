...
from rerank_fusion_v4 import RerankModel, Reader
# from rerank_fusion_v2 import RerankModel, Reader
import training_util
from config import TrainConfig


tf.flags.DEFINE_string("train_dir", "/import/vision-ephemeral/fl302/data/model/%s_kpvaq3_%s",
...
def train():
    ...
    reader = Reader(batch_size=128, subset='trainval', version='v1')
