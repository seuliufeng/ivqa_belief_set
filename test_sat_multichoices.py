...
import os
from util import get_res5c_feature_root, load_hdf5, update_progress, save_json, load_json
...
# models ['VAQ-IAS', 'VAQ-lstm', 'VQG', 'VAQ-A', 'VAQ-lstm-dec-sup', 'VAQ-lstm-dec']
tf.flags.DEFINE_string("model_type", "VQG",
                       "Select a model to train.")
# tf.flags.DEFINE_string("model_type", "VAQ-lstm",
#                        "Select a model to train.")
...
class MultipleChoiceEvaluater(object):
    ...
    def get_task_data(self):
        ...
        if self._use_ans_type:
            ...
            outputs += [quest, quest_len, None, ans, ans_len, answer_idx, image_id]
        self._idx += 1
        return outputs
...
if __name__ == '__main__':
    vaq_multiple_choices(checkpoint_path=None, subset='kpval')
