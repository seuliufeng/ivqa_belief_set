...
tf.flags.DEFINE_string("model_type", "VAQ-VarDSA-IAQ",
...
if __name__ == '__main__':
    ckpt = 'model/v1_var_kptrain_VAQ-VarDSA-IAQ/v1_var_kptrain_VAQ-VarDSA-IAQ_best2/model.ckpt-325000'
    vaq_multiple_choices(checkpoint_path=ckpt, subset='kptest')
