...
class RerankModel(object):
    ...
    def _build_gates(self):
        ...
        # compute temp
        temp_vqa = slim.fully_connected(ctx, 1, activation_fn=tf.nn.softplus, scope='softmax_temp_vqa')
        self._norm_vqa_scores = softmax_norm(self._vqa_scores, temp_vqa)
    ...
    def _fuse_outputs(self):
        ...
        self.preds = self._norm_vqa_scores * self._norm_ivqa_scores + self._vqa_scores
