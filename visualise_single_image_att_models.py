...
import var_rl_single_att_image_training_util as training_util
...
tf.flags.DEFINE_string("version", "v1",
                       ...
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "model/%s_var_tmp_restval_%s",
...
def train():
    ...
    env.set_replay_buffer(insert_thresh=0.1, sv_dir='vqa_replay_buffer/tmp')  # if 0.5, already fooled others
    ...
    with g.as_default():
        ...
        learning_rate = tf.constant(training_config.initial_learning_rate * 0.0)
