...
from n2mn_util.cnn import fc_layer as fc, conv_layer as conv
...
class NMN3Model:
    def __init__(self, image_feat_grid, text_seq_batch, seq_length_batch,
                 ...
                 num_choices, use_qpn, qpn_dropout, reduce_visfeat_dim=False,
                 new_visfeat_dim=256,
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            with tf.variable_scope('layout_generation'):
                ...
                word_vecs = att_seq2seq.word_vecs  # layout attended word vectors
            ...
            with tf.variable_scope('layout_execution'):
                ...
                print('------ N2MN model ------')
                print('Input type: %s' % output_scores.input_type)
                print('Output type: %s' % output_scores.output_type)
