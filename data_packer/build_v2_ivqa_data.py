...
tf.flags.DEFINE_string("output_dir", "/import/vision-ephemeral/fl302/code/vqa2.0/data/", "Output data directory.")
...
tf.flags.DEFINE_integer("num_top_answers", 2000,
                        "The minimum number of occurrences of each word in the "
                        "training set for inclusion in the vocabulary.")
tf.flags.DEFINE_string("word_counts_output_file", "/import/vision-ephemeral/fl302/code/vqa2.0/data/%s_word_counts.txt",
                       "Output vocabulary file of word counts.")
tf.flags.DEFINE_string("top_answer_output_file", "/import/vision-ephemeral/fl302/code/vqa2.0/data/%s_top%d_answers.txt",
                       "Output vocabulary file of word counts.")
...
def _process_dataset(subset, images, encoder):
    meta_filename = os.path.join(FLAGS.output_dir, 'v2_vqa_std_mscoco_%s.meta' % subset)
    data_filename = os.path.join(FLAGS.output_dir, 'v2_vqa_std_mscoco_%s.data' % subset)
