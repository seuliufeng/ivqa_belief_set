...
_black_list = ['do', 'have', 'be', 'many', 'it', 'different'] + question_items + nn_items + adjective_items
...
def process_visual_facts():
    vocab = Vocabulary()
    d = load_json('/usr/data/fl302/code/premise17/premises/vqa_val_spice_output_full.json')
    vis_facts = {}
