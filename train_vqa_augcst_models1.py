...
from readers.vqa_naive_cst_data_fetcher import ContrastiveDataReader as Reader

# from readers.vqa_naive_data_fetcher import AttentionDataReader as Reader
...
tf.flags.DEFINE_string("model_type", "VQA-CREG",
...
def train():
    ...
    reader = Reader(batch_size=32,
                    subset=FLAGS.model_trainset,
                    cst_file='vqa_replay_buffer/vqa_replay_low_rescore_prior_04.json')
