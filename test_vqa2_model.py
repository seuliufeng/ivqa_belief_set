...
from readers.vqa_curriculum_data_fetcher import AttentionFetcher

TEST_SET = 'dev'

tf.flags.DEFINE_string("model_type", "VQA2",
...
def test(checkpoint_path=None):
    ...
    to_sentence = SentenceGenerator(trainset='trainval',
                                    top_ans_file='model/mlb_attention_v2/vqa_trainval_top2000_answers.txt')
...
def main(_):
    ...
    test_model('model/mlb_attention_v2/model.ckpt-170000')
