...
from readers.vert_ap_data_fetcher import TestReader

TEST_SET = 'kpval'

tf.flags.DEFINE_string("model_type", "VertLR",
...
tf.flags.DEFINE_bool("retrain", True,
                     "Use all answer candidates or just two.")
tf.flags.DEFINE_bool("score_fusion", True,
                     "Use all answer candidates or just two.")
...
def test(checkpoint_path=None):
    ...
    for i in range(reader.num_batches):
        ...
        cand_scs, cands, _qids, image_ids = outputs[3:]
