...
from readers.dual_naive_data_fetcher import DualReader as Reader
...
tf.flags.DEFINE_string("version", "v1",
                       ...
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "model/%s_%s_dual",
...
def train():
    ...
    reader = Reader(batch_size=64, un_ratio=1)
