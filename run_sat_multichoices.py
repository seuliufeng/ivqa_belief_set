...
tf.flags.DEFINE_string("checkpoint_dir", "/import/vision-ephemeral/fl302/models/v1_kpvaq2_%s",
...
class MultipleChoiceEvaluater(object):
    def __init__(self, subset='val', num_eval=None, need_im_feat=True,
        ...
        anno_file = '/usr/data/fl302/code/iccv_vaq/data/MultipleChoicesQuestionsKarpathy%sV2.0.json' % subset.title()
        self._subset = subset
...
if __name__ == '__main__':
    vaq_multiple_choices(checkpoint_path=None, subset='kptest')
