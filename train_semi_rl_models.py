...
import semi_training_util as training_util
...
from models.semi_vqa_ivqa_rl_model import ModelVQAiVQA as model_fn

tf.flags.DEFINE_string("model_type", "Semi-RL-Restval",
...
def train():
    ...
    with g.as_default():
        ...
        learning_rate = tf.constant(training_config.initial_learning_rate) * 0.3
