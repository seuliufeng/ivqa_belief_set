...
import multiloss_training_util as training_util
...
tf.flags.DEFINE_string("version", "v2",
                       ...
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "/scratch/fl302/inverse_vqa/model/dbg_%s_kpvaq_%s_%s",
...
def train():
    ...
    model_config.loss_type = FLAGS.loss_type
    ...
    train_dir = FLAGS.train_dir % (FLAGS.version, FLAGS.model_type, FLAGS.loss_type)
    ...
    # create reader
    reader = reader_fn(batch_size=model_config.batch_size, subset='kptrain',
