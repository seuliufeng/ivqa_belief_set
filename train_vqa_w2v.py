...
from readers.vqa_w2v_data_fetcher import AttentionDataReader as Reader
...
# from models.vqa_base_w2v import BaseModel as model_fn
# from models.vqa_base_w2v_structured import BaseModel as model_fn
from models.vqa_base_w2v_structured2 import BaseModel as model_fn

tf.flags.DEFINE_string("model_type", "VQA-W2VS2",
                       "Select a model to train.")
tf.flags.DEFINE_string("version", "v1",
                       "Dataset version used for training, v1 for VQA 1.0, v2 "
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "model/%s_%s",
