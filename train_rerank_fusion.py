...
tf.flags.DEFINE_string("train_dir", "/import/vision-ephemeral/fl302/data/model/%s_kpvaq2_%s",
...
def train():
    ...
    train_dir = FLAGS.train_dir % ('v2', 'Fusion')
    ...
    # create reader
    # create reader
    reader = Reader(batch_size=128*4, subset='kptrain')
