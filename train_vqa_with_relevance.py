...
from readers.vq_matching_data_fetcher import AttentionDataReader as Reader
...
from models.vqa_relevance_base import BaseModel as model_fn

tf.flags.DEFINE_string("model_type", "VQA-REL",
