...
from readers.vqa_hard_curriculum_data_fetcher import AttentionFetcher

TEST_SET = 'test'

tf.flags.DEFINE_string("model_type", "VQA",
...
def main(_):
    ...
    test_model('model/v1_vqa_VQA/v1_vqa_VQA_best2/model.ckpt-135000')
