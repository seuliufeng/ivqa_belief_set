...
def main(_):
    models = ['MLB2-att', 'Vanilla', 'MLB-att', 'N2NMN', 'SL']
    ckpts = ['model/v1_var_rl_mlb2att_VAQ-VarRL2',
             'model/v1_var_ivqa_vanilla_VAQ-VarRL2',
             'model/v1_var_rl_att2_restval_VAQ-VarRL2_r2',
