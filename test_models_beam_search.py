...
def main(_):
    ...
    # ckpt_dir = 'model/v1_kpvaq2_VAQ-2Att/'
    print(ckpt_dir)
...
if __name__ == '__main__':
    # ckpt_dir = '/data1/fl302/projects/models/SAT/model.ckpt-117000'
    # res_file = ivqa_decoding_beam_search(checkpoint_path=ckpt_dir,
    #                                      subset='kptest')
    tf.app.run()
