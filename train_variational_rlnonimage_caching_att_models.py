...
import var_rl_att_cache_training_util as training_util
...
tf.flags.DEFINE_string("version", "v1",
                       ...
                       "for VQA 2.0.")
tf.flags.DEFINE_string("train_dir", "model/%s_var_att_noimage_cache_restval_%s",
...
def train():
    ...
    env.set_replay_buffer(insert_thresh=0.1,
                          sv_dir='vqa_replay_buffer/no_image')  # if 0.5, already fooled others
