...
from readers.vqa_naive_vqg_cand_data_fetcher import AttentionFetcher
...
def test(checkpoint_path=None):
    ...
    save_hdf5('data4/%svqg_%s_qa_scores.data' % (_model_suffix, FLAGS.testset),
